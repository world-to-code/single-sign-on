 ...
 * (the tenant's stable public identifier, normalized to lowercase, globally unique), its display
 * {@code name}, and the optional {@link CompanyProfile} collected at onboarding.
 */
