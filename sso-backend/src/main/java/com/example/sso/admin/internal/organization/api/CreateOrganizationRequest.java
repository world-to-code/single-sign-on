...
/**
 * Create request for an organization; maps itself to the {@link NewOrganization} command. Beyond the
 * required slug + name, it carries the optional Okta/Ping-style company profile collected at onboarding.
 */
