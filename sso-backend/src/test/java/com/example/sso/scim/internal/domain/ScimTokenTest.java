...
class ScimTokenTest {
    ...
    void aTokenWithNoExpiryIsAlwaysActive() {
        ScimToken token = new ScimToken("ci", "hash-1", null);
    ...
    void aTokenIsActiveBeforeItsExpiry() {
        ...
        ScimToken token = new ScimToken("ci", "hash-2", now.plusSeconds(60));
    ...
    void aTokenIsInactiveAfterItsExpiry() {
        Instant now = Instant.now();
        ScimToken token = new ScimToken("ci", "hash-3", now.minusSeconds(60));
