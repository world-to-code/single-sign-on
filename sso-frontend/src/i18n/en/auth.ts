export const auth = {
  ...
  profileAppSessionsSection: "Active app sessions",
  profileAppSessionsCol: "Application",
  profileAppLogoutTitle: "Sign out of this app?",
  profileAppLogoutDesc: "Your session at \"{{app}}\" will be ended. You stay signed in here and to your other apps.",
  profileAppLogoutUnsupported: "This app can only be signed out from the app itself.",
  ...
  mfaEmailVerifyPrompt: "This address has not been verified yet, so it cannot receive sign-in codes. Send yourself a verification code first — it only confirms the mailbox and will not sign you in.",
  mfaEmailVerifySend: "Send verification code",
  mfaEmailVerifySent: "Verification code sent. Enter it here and your sign-in code is sent right away.",
  mfaEmailVerifyConfirm: "Confirm mailbox",
  profileEmailDialogTitle: "Verify your email address",
  profileEmailDialogDesc: "A one-time code proves you control this mailbox. Until it does, the email code factor stays disabled.",
  profileEmailCodeSentTo: "Enter the code we emailed to {{email}}.",
  profileEmailSendFailed: "Could not send the code, try again.",
  profileEmailCodeInvalid: "Invalid code, try again.",
  profileEmailVerifyBtn: "Verify",
  ...
  reauthEmailExplain: "A one-time code sent to your email",
  reauthEnterTotp: "Enter the code from your authenticator",
  reauthEnterEmail: "Enter the code we emailed you",
  reauthResendCode: "Resend",
