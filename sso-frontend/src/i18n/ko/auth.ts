...
export const auth: Record<keyof typeof enAuth, string> = {
  ...
  signupNoApproval: "승인 절차는 없습니다. 이메일만 확인하면 됩니다.",
  ...
  activateMissingToken: "이 링크에는 토큰이 없습니다. 확인 이메일에 있는 링크를 그대로 사용하세요.",
  ...
  setPasswordMissingToken: "이 링크에는 토큰이 없습니다. 초대 이메일에 있는 링크를 그대로 사용하세요.",
  ...
  mfaEmailVerifyPrompt: "아직 인증되지 않은 주소라 로그인 코드를 받을 수 없습니다. 먼저 인증 코드를 받으세요. 메일함 확인용이라 이 코드로는 로그인되지 않습니다.",
  mfaEmailVerifySend: "인증 코드 보내기",
  mfaEmailVerifySent: "인증 코드를 보냈습니다. 받은 코드를 입력하면 로그인 코드를 바로 보내 드립니다.",
  mfaEmailVerifyConfirm: "메일함 인증 확인",
  profileEmailDialogTitle: "이메일 주소 인증",
  profileEmailDialogDesc: "일회용 코드로 이 메일함을 사용할 수 있음을 증명합니다. 증명 전까지 이메일 코드 인증 수단은 비활성 상태입니다.",
  profileEmailCodeSentTo: "{{email}}(으)로 보낸 코드를 입력하세요.",
  profileEmailSendFailed: "코드를 보내지 못했습니다. 다시 시도하세요.",
  profileEmailCodeInvalid: "코드가 올바르지 않습니다. 다시 시도하세요.",
  profileEmailVerifyBtn: "인증",
